...
namespace Login_Form {
    ...
    public partial class ProductsDataSet1 : global::System.Data.DataSet {
        ...
        public partial class ProductsDataTable : global::System.Data.TypedTableBase<ProductsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public ProductsRow AddProductsRow(string productName, int barcode, string category, int quantity, int price, byte[] productPhoto) {
        ...
        public partial class ProductsRow : global::System.Data.DataRow {
            ...
            public byte[] productPhoto {
                get {
                    try {
                        return ((byte[])(this[this.tableProducts.productPhotoColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'productPhoto\' in table \'Products\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tableProducts.productPhotoColumn] = value;
                }
            }
            ...
            public bool IsproductPhotoNull() {
                return this.IsNull(this.tableProducts.productPhotoColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public void SetproductPhotoNull() {
                this[this.tableProducts.productPhotoColumn] = global::System.Convert.DBNull;
            }
        }
...
namespace Login_Form.ProductsDataSet1TableAdapters {
    ...
    public partial class ProductsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Products] WHERE (([productId] = @Original_productId) AND ((@IsNull_productName = 1 AND [productName] IS NULL) OR ([productName] = @Original_productName)) AND ((@IsNull_barcode = 1 AND [barcode] IS NULL) OR ([barcode] = @Original_barcode)) AND ((@IsNull_category = 1 AND [category] IS NULL) OR ([category] = @Original_category)) AND ((@IsNull_quantity = 1 AND [quantity] IS NULL) OR ([quantity] = @Original_quantity)) AND ((@IsNull_price = 1 AND [price] IS NULL) OR ([price] = @Original_price)))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Products] ([productName], [barcode], [category], [quantity], [price], [productPhoto]) VALUES (@productName, @barcode, @category, @quantity, @price, @productPhoto);
SELECT productId, productName, barcode, category, quantity, price, productPhoto FROM Products WHERE (productId = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Products] SET [productName] = @productName, [barcode] = @barcode, [category] = @category, [quantity] = @quantity, [price] = @price, [productPhoto] = @productPhoto WHERE (([productId] = @Original_productId) AND ((@IsNull_productName = 1 AND [productName] IS NULL) OR ([productName] = @Original_productName)) AND ((@IsNull_barcode = 1 AND [barcode] IS NULL) OR ([barcode] = @Original_barcode)) AND ((@IsNull_category = 1 AND [category] IS NULL) OR ([category] = @Original_category)) AND ((@IsNull_quantity = 1 AND [quantity] IS NULL) OR ([quantity] = @Original_quantity)) AND ((@IsNull_price = 1 AND [price] IS NULL) OR ([price] = @Original_price)));
SELECT productId, productName, barcode, category, quantity, price, productPhoto FROM Products WHERE (productId = @productId)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Login_Form.Properties.Settings.Default.ProductsConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT productId, productName, barcode, category, quantity, price, productPhoto F" +
                "ROM dbo.Products";
        ...
        public virtual int Fill(ProductsDataSet1.ProductsDataTable dataTable) {
        ...
        public virtual ProductsDataSet1.ProductsDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            ProductsDataSet1.ProductsDataTable dataTable = new ProductsDataSet1.ProductsDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(ProductsDataSet1.ProductsDataTable dataTable) {
        ...
        public virtual int Delete(int Original_productId, string Original_productName, global::System.Nullable<int> Original_barcode, string Original_category, global::System.Nullable<int> Original_quantity, global::System.Nullable<int> Original_price) {
            ...
            if ((Original_barcode.HasValue == true)) {
                ...
                this.Adapter.DeleteCommand.Parameters[4].Value = ((int)(Original_barcode.Value));
            }
            else {
        ...
        public virtual int Insert(string productName, global::System.Nullable<int> barcode, string category, global::System.Nullable<int> quantity, global::System.Nullable<int> price, byte[] productPhoto) {
            if ((productName == null)) {
        ...
        public virtual int Update(string productName, global::System.Nullable<int> barcode, string category, global::System.Nullable<int> quantity, global::System.Nullable<int> price, byte[] productPhoto, int Original_productId, string Original_productName, global::System.Nullable<int> Original_barcode, string Original_category, global::System.Nullable<int> Original_quantity, global::System.Nullable<int> Original_price, int productId) {
            if ((productName == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string productName, global::System.Nullable<int> barcode, string category, global::System.Nullable<int> quantity, global::System.Nullable<int> price, byte[] productPhoto, int Original_productId, string Original_productName, global::System.Nullable<int> Original_barcode, string Original_category, global::System.Nullable<int> Original_quantity, global::System.Nullable<int> Original_price) {
            return this.Update(productName, barcode, category, quantity, price, productPhoto, Original_productId, Original_productName, Original_barcode, Original_category, Original_quantity, Original_price, Original_productId);
        }
    }
