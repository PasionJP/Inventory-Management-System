...
namespace Login_Form {
    ...
    public partial class EmployeesDataSet1 : global::System.Data.DataSet {
        ...
        public partial class EmployeesDataTable : global::System.Data.TypedTableBase<EmployeesRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public EmployeesRow AddEmployeesRow(string FirstName, string MiddleName, string LastName, string Sex, System.DateTime Birthday, string Address, string Email, int ContactNumber, byte[] EmployeePhoto, string UserType, string UserName) {
...
namespace Login_Form.EmployeesDataSet1TableAdapters {
    ...
    public partial class EmployeesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Employees] ([FirstName], [MiddleName], [LastName], [Sex], [Birthday], [Address], [Email], [ContactNumber], [EmployeePhoto], [UserType], [UserName]) VALUES (@FirstName, @MiddleName, @LastName, @Sex, @Birthday, @Address, @Email, @ContactNumber, @EmployeePhoto, @UserType, @UserName);
SELECT EmployeeID, FirstName, MiddleName, LastName, Sex, Birthday, Address, Email, ContactNumber, EmployeePhoto, UserType, UserName FROM Employees WHERE (EmployeeID = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Employees] SET [FirstName] = @FirstName, [MiddleName] = @MiddleName, [LastName] = @LastName, [Sex] = @Sex, [Birthday] = @Birthday, [Address] = @Address, [Email] = @Email, [ContactNumber] = @ContactNumber, [EmployeePhoto] = @EmployeePhoto, [UserType] = @UserType, [UserName] = @UserName WHERE (([EmployeeID] = @Original_EmployeeID) AND ((@IsNull_FirstName = 1 AND [FirstName] IS NULL) OR ([FirstName] = @Original_FirstName)) AND ((@IsNull_MiddleName = 1 AND [MiddleName] IS NULL) OR ([MiddleName] = @Original_MiddleName)) AND ((@IsNull_LastName = 1 AND [LastName] IS NULL) OR ([LastName] = @Original_LastName)) AND ((@IsNull_Sex = 1 AND [Sex] IS NULL) OR ([Sex] = @Original_Sex)) AND ((@IsNull_Birthday = 1 AND [Birthday] IS NULL) OR ([Birthday] = @Original_Birthday)) AND ((@IsNull_Address = 1 AND [Address] IS NULL) OR ([Address] = @Original_Address)) AND ((@IsNull_Email = 1 AND [Email] IS NULL) OR ([Email] = @Original_Email)) AND ((@IsNull_ContactNumber = 1 AND [ContactNumber] IS NULL) OR ([ContactNumber] = @Original_ContactNumber)) AND ((@IsNull_UserType = 1 AND [UserType] IS NULL) OR ([UserType] = @Original_UserType)) AND ((@IsNull_UserName = 1 AND [UserName] IS NULL) OR ([UserName] = @Original_UserName)));
SELECT EmployeeID, FirstName, MiddleName, LastName, Sex, Birthday, Address, Email, ContactNumber, EmployeePhoto, UserType, UserName FROM Employees WHERE (EmployeeID = @EmployeeID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT EmployeeID, FirstName, MiddleName, LastName, Sex, Birthday, Address, Email" +
                ", ContactNumber, EmployeePhoto, UserType, UserName FROM dbo.Employees";
        ...
        public virtual int Insert(string FirstName, string MiddleName, string LastName, string Sex, global::System.Nullable<global::System.DateTime> Birthday, string Address, string Email, global::System.Nullable<int> ContactNumber, byte[] EmployeePhoto, string UserType, string UserName) {
            if ((FirstName == null)) {
        ...
        public virtual int Update(
            ...
            if ((Original_ContactNumber.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[27].Value = ((int)(Original_ContactNumber.Value));
            }
            else {
            ...
            if ((Original_UserType == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[29].Value = ((string)(Original_UserType));
            }
            if ((Original_UserName == null)) {
        ...
        public virtual int Update(
                    ...
                    string Original_UserType, 
                    string Original_UserName) {
            return this.Update(FirstName, MiddleName, LastName, Sex, Birthday, Address, Email, ContactNumber, EmployeePhoto, UserType, UserName, Original_EmployeeID, Original_FirstName, Original_MiddleName, Original_LastName, Original_Sex, Original_Birthday, Original_Address, Original_Email, Original_ContactNumber, Original_UserType, Original_UserName, Original_EmployeeID);
        }
    }
